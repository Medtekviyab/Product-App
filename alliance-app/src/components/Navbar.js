  ...
  return (
    <div>
      ...
      <header className="container max-w-7xl mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-between">
        ...
        <button type="button" class="inline-flex justify-center items-center py-2 px-4 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-black dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Sign In</button>
        </div>
      </header>
    </div>
  );
